...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "avaliacao360ericb@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "avaliacao360ericb API";

        private String description = "avaliacao360ericb API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "avaliacao360ericb";
