...
class EquipeGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("avaliacao360ericbapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Equipe entity")
        ...
        .formParam("client_id", "avaliacao360ericbapp")
